import pickle
import torch
from autoencoder_model_maze_grayscale import *
...
class Agent():
    ...
    def obstacle_channel(self, img):
        obs_channel = img[..., 0]
        obs_channel = np.expand_dims(obs_channel, 2)
        return obs_channel
